...
<input type="company" class="form-control"  name="company" value="<?= $Employee->company ?>">
</div>
...
<button  type="add" class="btn btn-primary  p-2" name="submit" name="submit">Submit</button>
